...
// get specific inputs
app.post("/inputs_index", (req, res) => {
  // console.log(req.body);
  UserController.get_specific_inputs(req.body).then((result) => {
    res.status(200).send(result);
  }).catch((err) => {
    res.status(400).send(err);
  });
...
app.post("/check_same_answer", (req, res) => {
  // console.log(req.body);
  UserController.sameAnswer(req.body).then((result) => {
    res.status(200).send(result);
  }).catch((err) => {
    res.status(400).send(err);
  });
...
// save plagaarism
app.post("/save_plagarism", (req, res) => {
  console.log(req.body);
  UserController.save_plagarism(req.body).then((result) => {
    res.status(200).send(result);
  }).catch((err) => {
    res.status(400).send(err);
  });
